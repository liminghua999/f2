...
def paginate(context, object_list, page_count):
    ...
    page = context['request'].GET.get('p',1) # 从 Http 请求中获取用户请求的页码号
    ...
    try:
        ...
        # 那么假如当前页是5，则 pages = [3,4,5,6,7],当然一些细节需要处理，比如如果当前页是2，那么获取的是pages = [1,2,3,4]
    ...
    context['cls_list'] = object_list # 把获取到的分页的数据封装到上下文中
    ...
    try:
        ...
        # 比如本身只有一个分页，那么pages就为空，因为我们永远不会获取页码为1的页码号
        # （至少有1页，1的页码号已经固定写在模板文件中）
